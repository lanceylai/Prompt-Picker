...
<a href="https://chromewebstore.google.com/detail/prompt-picker/lgcmgmlbomeodhmikhiphmonogmfdeeg"><img src="https://upload.wikimedia.org/wikipedia/commons/c/c5/Google_Chrome_Web_Store_icon_2015.svg" alt="Chrome Web Store" width="28" height="28" /> 从 Chrome Web Store 安装 Prompt Picker</a>
...
![使用 Prompt Picker 在页面上直接选择元素](assets/show_guide_1.png)

![填写修改说明、复制生成的 prompt](assets/show_guide_2.png)

![并粘贴到 AI 编程工具](assets/show_guide_3.png)

## 👥 适合谁使用

| 角色 | Prompt Picker 如何帮助你 |
| --- | --- |
| 产品经理 | 描述 UI 修改、交互问题或产品建议时，直接点选页面中的具体位置，让反馈更清楚。 |
| 研发工程师 | 为 AI 编程工具提供准确上下文，让它理解“到底要改哪个元素”以及去哪里找相关代码。 |
